  ...
  try {
    ...
    await sql`
      ...
      (
        ...
        '• ตรวจวัดสิ่งแวดล้อมในการทำงาน ประเมินผลกระทบสุขภาพและสิ่งแวดล้อม (Monitor/EIA)\n• การควบคุมสุขาภิบาลอาหารและน้ำ การจัดการมลพิษ และการให้คำปรึกษามาตรฐาน ISO 14001 & ISO/IEC 17025\n• EIA โครงการที่พักอาศัยในเครือ KANTARY / แสนสิริ / พฤกษา\n• Monitor โครงการเด่นๆ อาทิเช่น โครงการทางหลวงพิเศษระหว่างเมือง M.6 (บางปะอิน-โคราช) M.7 (ชลบุรี-พัทยา-มาบตาพุด)',
        2
      );
    `;
